...
const pageTexts = [
    ...
    // Page 3
    "Morphée the calico cat was already sitting on the window sill, her tail swishing back and forth. I've been watching him for a while, she purred. He's leaving colorful eggs all around our farm! Look at that trail of eggs!",
    ...
    // Page 8
    "They came to a big mud puddle. Oh boy! My favorite! exclaimed Heidi, and she jumped right in, rolling around happily. She got completely covered in mud from her spots to her floppy ears. Morphée carefully walked around the puddle, keeping her paws clean.",

    // Page 9
    "I have an idea! meowed Morphée. With her sharp claws, she quickly climbed up the tallest tree. From the top, she could see the whole farm. There he is! He's heading toward the pond! she called down to her friends, her calico fur shining in the sunlight.",
    ...
    // Page 14
    "Luna used her excellent nose to sniff out eggs hidden in the dirt. Heidi found eggs near the pond (and got even muddier!). Morphée climbed trees to find eggs in bird nests. Randy used his loud bark to call out whenever anyone found an egg. They were a great team!",
